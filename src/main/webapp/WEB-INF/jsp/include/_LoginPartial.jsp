...
<sec:authorize access="isAuthenticated()">
    <form action="/springboot/Account/LogOff" id="logoutForm" method="post">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li>
                ...
                <a href="/springboot/Manage" title="Manage">Hello ${user.username}!</a>
            </li>
...
<sec:authorize access="isAnonymous()">
    <ul class="nav navbar-nav navbar-right">
        <li><a href="/springboot/Login" id="loginLink">로그인</a></li>
    </ul>
</sec:authorize>